...
import com.ironghui.datatree.DataBean.Sertest;
import com.ironghui.datatree.activity.GetSharedPreferenceActivity;
...
public class SharedPreferenceActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Intent intent = new Intent(this, GetSharedPreferenceActivity.class);

        Sertest p = new Sertest();
        String key = "name";
        saveObject(this, key, p);
        readObject(this,key);
    }
