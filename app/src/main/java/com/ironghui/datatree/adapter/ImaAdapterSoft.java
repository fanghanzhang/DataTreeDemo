...
public class ImaAdapterSoft extends ArrayAdapter {
    ...
    public ImaAdapterSoft(Context context, int resource, String[] objects) {
        super(context, resource, objects);
        mLoadingBitmap = BitmapFactory.decodeResource(context.getResources(),R.drawable.comm_error);
        // 获取应用程序最大可用内存  
    ...
    public boolean cancelPotentialWork(String url, ImageView imageView) {
        BitmapWorkerTask bitmapWorkerTask = getBitmapWorkerTask(imageView);//获取传入的ImageView它所对应的BitmapWorkerTask
    ...
    class BitmapWorkerTask extends AsyncTask<String, Void, BitmapDrawable> {
        ...
        protected void onPostExecute(BitmapDrawable drawable) {
            ImageView imageView = getAttachedImageView();//获取当前BitmapWorkerTask所关联的ImageView。
